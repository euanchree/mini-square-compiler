        ...
        private static string ToString(ImmutableList<bool> lastChild, IAbstractSyntaxTreeNode node)
        {
            switch (node)
            {
                ...
                case QuickIfCommandNode quickIfCommand:
                    return NodeToString(lastChild, quickIfCommand, quickIfCommand.Expression, quickIfCommand.Command);

                case LoopCommandNode loopCommand:
                    return NodeToString(lastChild, loopCommand, loopCommand.LoopCommand, loopCommand.Expression, loopCommand.WhileCommand);
                ...
                case CallExpressionNode callExpresion:
                    return NodeToString(lastChild, callExpresion, callExpresion.Identifier, callExpresion.Parameter);

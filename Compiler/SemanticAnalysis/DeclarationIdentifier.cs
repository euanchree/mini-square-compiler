    ...
    public class DeclarationIdentifier
    {
        ...
        private void PerformIdentification(IAbstractSyntaxTreeNode node)
        {
            if (node is null)
            {
                ...
                WriteError("Tried to perform identification on a null tree node", node);
            }
            else if (node is ErrorNode)
            {
                ...
                WriteError("Tried to perform identification on an error tree node", node);
            }
            else
            {
                ...
                if (function == null)
                {
                    ...
                    WriteError($"Couldn't find the function {functionName} when doing identification", node);
                }
                else
        ...
        /// <summary>
        /// Carries out identification on a quick if command node
        /// </summary>
        /// <param name="quickIfCommand">The node to perform identification on</param>
        private void PerformIdentificationOnQuickIfCommand(QuickIfCommandNode quickIfCommand)
        {
            ...
            PerformIdentification(quickIfCommand.Command);
        }
        ...
        /// </summary>
        /// <param name="loopCommand">The node to perform indentification on</param>
        private void PerformIdentificationOnLoopCommand(LoopCommandNode loopCommand)
        {
            ...
            PerformIdentification(loopCommand.WhileCommand);
        }
        ...
        /// <summary>
        /// Write error message from the indentifier
        /// </summary>
